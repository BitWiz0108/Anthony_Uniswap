...
const stablePoolAsset = "ETH.USDT-0XDAC17F958D2EE523A2206206994597C13D831EC7";
...
export async function apiRequest(path) {
  return await (await fetch("https://midgard.mayachain.info/v2" + path)).json();
}
export async function nodeRequest(path) {
  return await (
    await fetch("https://mayanode.mayachain.info/mayachain" + path)
  ).json();
}
